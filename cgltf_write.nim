{.compile: "cgltf_write.cc".}

type
  INNER_C_UNION_cgltf_write_339* {.bycopy.} = object {.union.}
  ...
  cgltf_camera* {.bycopy.} = object
    ...
    data*: INNER_C_UNION_cgltf_write_339
    extras*: cgltf_extras
...
proc cgltf_copy_extras_json*(data: ptr cgltf_data; extras: ptr cgltf_extras;
                            dest: cstring;
                                dest_size: ptr cgltf_size): cgltf_result {.
                                    cdecl, importc.}
proc cgltf_write_file*(options: ptr cgltf_options; path: cstring;
    data: ptr cgltf_data): cgltf_result {.cdecl, importc.}
proc cgltf_write*(options: ptr cgltf_options; buffer: cstring; size: cgltf_size;
                 data: ptr cgltf_data): cgltf_size {.cdecl, importc.}
